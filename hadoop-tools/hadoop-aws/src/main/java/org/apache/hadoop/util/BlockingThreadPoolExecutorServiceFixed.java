...
public final class BlockingThreadPoolExecutorServiceFixed
    extends SemaphoredDelegatingExecutorFixed {

  private static final Logger LOG = LoggerFactory
      .getLogger(BlockingThreadPoolExecutorServiceFixed.class);
  ...
  /**
   * Returns a {@link ThreadFactory} that names each
  ...
  private BlockingThreadPoolExecutorServiceFixed(int permitCount,
   ...
   */
  public static BlockingThreadPoolExecutorServiceFixed newInstance(
      int activeTasks,
      int waitingTasks,
    ...
    return new BlockingThreadPoolExecutorServiceFixed(waitingTasks + activeTasks,
